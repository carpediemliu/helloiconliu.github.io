...
<p>共勉。<br>
——————————————<br>
继上一篇的连接连接之后（见<a href="http://vitoliu.top/2017/12/27/ActiveMQ源码阅读笔记-一-2017/" target="_blank">http://vitoliu.top/2017/12/27/ActiveMQ源码阅读笔记-一-2017/</a>），<p>客户端的的下一步操作一般是
</p>
<pre>
<code>
...
<pre><code>    protected ActiveMQSession(ActiveMQConnection connection, SessionId sessionId, int acknowledgeMode, boolean asyncDispatch, boolean sessionAsyncDispatch) throws JMSException {
